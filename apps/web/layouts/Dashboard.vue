...
<template>
  <div class="h-screen w-screen flex flex-col">
    <div v-if="!user.getMe?.emailVerified" class="flex flex-row gap-2 w-screen h-10 bg-yellow-100 text-yellow-800 justify-center items-center">
      ...
      <Button variant="outline" size="sm" @click="router.push('dashboard/profile#verify')">Go to email verification</Button>
    </div>
                    ...
                    >
                      ...
                      <i
                        :class="cn('ml-auto h-4 w-4 fas fa-check',
                                     organizationStore.selectedOrganization?.id === organization.id
                                       ? 'opacity-100'
                                       : 'opacity-0',
                      )"
                      />
                ...
                <CommandList>
                  <CommandGroup>
                    <DialogTrigger as-child>
                      <CommandItem
                        value="create-organization" @select="() => {
    ...
    <main class="flex justify-center items-center h-full bg-gray-100 z-0 relative">
      <slot/>
    </main>
  </div>
</template>
